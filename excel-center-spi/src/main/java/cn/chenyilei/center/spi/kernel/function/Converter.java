...
public abstract class Converter<A, B> implements Function<A, B> {
    ...
    public Iterable<B> convertAll(final Iterable<? extends A> fromIterable) {
        if (fromIterable == null) {
            throw new IllegalArgumentException("fromIterable is null");
        }
    ...
    <C> Converter<A, C> doAndThen(Converter<B, C> secondConverter) {
        if (secondConverter == null) {
            throw new IllegalArgumentException("secondConverter is null");
        }
    ...
    private static final class FunctionBasedConverter<A, B> extends Converter<A, B>
        ...
        private FunctionBasedConverter(Function<? super A, ? extends B> forwardFunction,
            ...
            if (forwardFunction == null) {
                throw new IllegalArgumentException("forwardFunction is null");
            }
            if (backwardFunction == null) {
                throw new IllegalArgumentException("backwardFunction is null");
            }
    ...
    private static final class IdentityConverter<T> extends Converter<T, T> implements Serializable {
        ...
        <S> Converter<T, S> doAndThen(Converter<T, S> otherConverter) {
            if (otherConverter == null) {
                throw new IllegalArgumentException("otherConverter is null");
            }

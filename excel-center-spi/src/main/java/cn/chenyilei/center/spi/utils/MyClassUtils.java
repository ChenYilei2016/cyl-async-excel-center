...
import cn.chenyilei.center.spi.convert.BasicType;
...
public class MyClassUtils {
    ...
    public static Set<String> getPublicMethodNames(Class<?> clazz) {
        return MyReflectUtils.getPublicMethodNames(clazz);
    }
    ...
    public static Method[] getPublicMethods(Class<?> clazz) {
        return MyReflectUtils.getPublicMethods(clazz);
    }
    ...
    public static List<Method> getPublicMethods(Class<?> clazz, Predicate<Method> filter) {
        return MyReflectUtils.getPublicMethods(clazz, filter);
    }
    ...
    public static List<Method> getPublicMethods(Class<?> clazz, Method... excludeMethods) {
        return MyReflectUtils.getPublicMethods(clazz, excludeMethods);
    }
    ...
    public static List<Method> getPublicMethods(Class<?> clazz, String... excludeMethodNames) {
        return MyReflectUtils.getPublicMethods(clazz, excludeMethodNames);
    }
    ...
    public static Method getPublicMethod(Class<?> clazz, String methodName, Class<?>... paramTypes) {
        return MyReflectUtils.getPublicMethod(clazz, methodName, paramTypes);
    }
    ...
    public static Set<String> getDeclaredMethodNames(Class<?> clazz) {
        return MyReflectUtils.getMethodNames(clazz);
    }
    ...
    public static Method[] getDeclaredMethods(Class<?> clazz) {
        return MyReflectUtils.getMethods(clazz);
    }
    ...
    public static Method getDeclaredMethod(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
        return MyReflectUtils.getMethod(clazz, methodName, parameterTypes);
    }
    ...
    public static boolean isAllAssignableFrom(Class<?>[] types1, Class<?>[] types2) {
        if (MyArrayUtils.isEmpty(types1) && MyArrayUtils.isEmpty(types2)) {
            return true;
        }
    ...
    public static Class<?> getTypeArgument(Class<?> clazz, int index) {
        final Type argumentType = MyTypeUtils.getTypeArgument(clazz, index);
    ...
    public static String getPackage(Class<?> clazz) {
        ...
        int packageEndIndex = className.lastIndexOf(MyCharUtils.DOT);
    ...
    public static ClassLoader getClassLoader() {
        return getClassLoader(MyClassUtils.class);
    }

...
import cn.chenyilei.aec.infrastructure.oss.AecOssConfig;
...
public class LocalDomainServiceConfiguration {
    ...
    @Bean
    public AecLocalFileOssServiceImpl aecOssService(AecOssConfig aecOssConfig){
        return new AecLocalFileOssServiceImpl(aecOssConfig.getLocal().getBasePath());
    }
}
